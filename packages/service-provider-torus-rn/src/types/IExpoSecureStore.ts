 ...
 * is locked.
 */
export const { AFTER_FIRST_UNLOCK } = ExpoSecureStore;
 ...
 * from a backup.
 */
export const { AFTER_FIRST_UNLOCK_THIS_DEVICE_ONLY } = ExpoSecureStore;
 ...
 */
export const { ALWAYS } = ExpoSecureStore;
 ...
 */
export const { WHEN_PASSCODE_SET_THIS_DEVICE_ONLY } = ExpoSecureStore;

// @needsAudit
/**
 * Similar to `ALWAYS`, except the entry is not migrated to a new device when restoring from a backup.
 */
export const { ALWAYS_THIS_DEVICE_ONLY } = ExpoSecureStore;

// @needsAudit
/**
 * The data in the keychain item can be accessed only while the device is unlocked by the user.
 */
export const { WHEN_UNLOCKED } = ExpoSecureStore;
 ...
 * a backup.
 */
export const { WHEN_UNLOCKED_THIS_DEVICE_ONLY } = ExpoSecureStore;
